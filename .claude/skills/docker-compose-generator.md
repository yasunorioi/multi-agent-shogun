---
description: >
  Generates Docker Compose configurations from project requirements.
  Supports IoT/Web stacks: Node-RED, Mosquitto, InfluxDB, PostgreSQL, Grafana, Redis, Nginx.
  Use when: "Docker Compose", "docker-compose生成", "container setup", "コンテナ環境",
  "Docker化", "dockerize", "Node-RED Docker", "IoT基盤Docker", "Docker stack".
  Do NOT use for: testing existing Docker Compose (use docker-compose-test) or running pytest in Docker (use docker-pytest-runner).
argument-hint: "<services e.g. nodered,mosquitto,influxdb> [--project my-iot]"
---
