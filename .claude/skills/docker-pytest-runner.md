---
description: >
  Runs pytest inside Docker containers for projects with system library dependencies
  (MeCab, libxml2, ImageMagick, ffmpeg). Builds a test container and executes tests locally.
  Use when: "Docker pytest", "Dockerテスト", "pytest in container", "コンテナ内テスト",
