---
description: >
  Generates 3D-printable IoT node enclosures as OpenSCAD source code.
  Parametric design adapts to board dimensions, sensor size, fan size.
  Use when: "enclosure", "筐体", "ケース設計", "case design", "3D print case",
  "3Dプリント筐体", "OpenSCAD enclosure", "IoT enclosure", "ハウジング設計".
  Do NOT use for: mechanical CAD beyond simple enclosures or non-3D-printable designs.
argument-hint: "<preset e.g. indoor-climate-node | custom> [--board-size 51x21x12] [--fan 30mm]"
---
# IoTノード筐体ジェネレーター
