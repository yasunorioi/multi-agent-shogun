---
description: >
  Generates customized ESP32-CAM timelapse firmware for Arduino/PlatformIO.
  Configurable capture intervals, storage options (SD/FTP), and MQTT integration.
  Use when: "timelapse", "タイムラプス", "ESP32-CAM", "定点カメラ",
  "crop monitoring camera", "作物成長記録", "construction progress camera".
  Do NOT use for: video streaming, non-ESP32 cameras, or image processing/ML tasks.
argument-hint: "<project_name e.g. house1-cam> [--interval 30m] [--storage sd|ftp]"
---
