---
description: >
  Generates an I2C sensor auto-detection module for CircuitPython/MicroPython.
  Scans I2C bus, identifies sensors by address + probe-based discrimination.
  Use when: "sensor auto detect", "センサー自動検出", "I2C scan", "I2Cスキャン",
  "plug and play sensor", "プラグアンドプレイ", "sensor identification".
  Do NOT use for: single known-sensor driver generation (use sensor-driver-generator instead).
argument-hint: "<sensors e.g. sht31,scd40,bmp280> [--platform circuitpython|micropython]"
---
