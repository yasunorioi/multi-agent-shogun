---
description: >
  Generates Node-RED + Mosquitto MQTT Broker setup guides. Supports Docker Compose and native install.
  Outputs step-by-step instructions, docker-compose.yaml, mosquitto.conf, and settings.js.
  Use when: "Node-RED setup", "Node-REDセットアップ", "Mosquitto setup",
  "MQTT broker setup", "MQTTブローカー構築", "Node-RED Docker", "Node-RED環境構築".
  Do NOT use for: Node-RED flow generation (use nodered-timer-flow-generator or nodered-error-alert-flow-generator).
argument-hint: "<docker|native> [--os ubuntu|raspbian] [--auth basic] [--tls true]"
---
