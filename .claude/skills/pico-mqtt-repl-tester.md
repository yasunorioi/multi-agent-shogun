...
description: >
  Tests MQTT publish/subscribe on Pico W / W5500-EVB-Pico via CircuitPython REPL over serial.
  Sends REPL commands via pyserial, parses results, generates structured test reports.
  Use when: "REPL test", "REPLテスト", "serial MQTT test", "シリアルMQTTテスト",
  "firmware MQTT check", "ファームウェアMQTT確認", "hardware inspection", "基板検品".
  Do NOT use for: network-based health checks (use pico-mqtt-health-checker), non-CircuitPython devices.
argument-hint: "<serial_port e.g. /dev/ttyACM0> [--broker 192.168.1.100] [--qos 0|1]"
---
