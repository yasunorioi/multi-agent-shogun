---
description: >
  Generates MCU/SBC pinout diagrams, wiring diagrams, and GPIO assignment tables
  in ASCII art and Markdown. Supports Pico W, Pico 2 W, ESP32, W5500-EVB-Pico, UniPi, etc.
  Use when: "pinout", "ピン配置", "wiring diagram", "配線図",
  "GPIO assignment", "GPIO割り当て", "pin diagram", "ピンアサイン".
  Do NOT use for: PCB design (use agri-iot-board-design-template) or schematic capture.
argument-hint: "<board e.g. pico-w|esp32|w5500-evb-pico> [--sensors sht40,bmp280] [--output full|table|ascii]"
---
