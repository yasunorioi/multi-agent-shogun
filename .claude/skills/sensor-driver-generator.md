---
description: >
  Generates I2C sensor drivers for CircuitPython/MicroPython from sensor specifications.
  Produces adafruit_bus_device-based code with CRC verification and property-based API.
  Use when: "sensor driver", "センサードライバ", "I2C driver", "ドライバ生成",
  "CircuitPython sensor", "MicroPython sensor library", "datasheet to driver".
  Do NOT use for: SPI-only sensors, analog sensors, or non-I2C communication protocols.
argument-hint: "<sensor_model e.g. SHT31, SCD30, BME280> [--lang circuitpython|micropython]"
---
