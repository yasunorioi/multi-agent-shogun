...
| 軍師 | multiagent:agents.1 | multiagent |
| 足軽1 | multiagent:agents.2 | multiagent |
| 足軽2 | multiagent:agents.3 | multiagent |
| 部屋子1(ashigaru6) | multiagent:agents.4 | multiagent |
| お針子 | ooku:agents.0 | ooku |
| 高札 | ooku:agents.1 | ooku (Docker, API: http://localhost:8080) |
| ccusage | ooku:agents.2 | ooku |
