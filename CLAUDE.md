...
- **ペイン対応表（3セッション構成）**:
  ...
  - **ookuセッション**: 部屋子1=`ooku:agents.0`, 部屋子2=`ooku:agents.1`, お針子=`ooku:agents.2`, 高札=`ooku:agents.3`（Dockerコンテナ、高札API http://localhost:8080）
...
- Pane 3: kousatsu（高札）- Dockerコンテナ、通信ハブ+検索API
